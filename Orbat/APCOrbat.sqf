	...
	switch (_type) do
	{
			...
			case "SR":
		{
			...
			_unit addMagazines["rhs_30Rnd_545x39_AK",6];
			_unit addMagazine "rhs_30Rnd_545x39_AK_green";
			_unit addMagazine "rhs_mag_rdg2_white";
			_unit addMagazine "rhs_mag_rdg2_white";
			_unit addMagazine "rhs_mag_rgd5";
			...
			case "ARPG":
		{
			...
			case "RPK":
		{
			_unit addMagazine ["JO_45rnd_RPK74",7];
			_unit addMagazine "rhs_mag_rgd5";
			_unit addMagazine "rhs_mag_rdg2_white";
			_unit addWeapon "JO_RF_RPK74M";
		};	
		...
		case "SVD":
		{
			_unit addMagazines["rhs_10Rnd_762x54mmR_7N1",6];
			_unit addMagazine "rhs_mag_rgd5";
			_unit addMagazine "rhs_mag_rgd5";
			_unit addMagazine "rhs_mag_rdg2_white";
			...
			case "BTR":
		{
			...
			_unit addMagazineCargoGlobal ["JO_45rnd_RPK74", 15];
